...
const Input = forwardRef(({label, id, type = 'text', stylesType, validateStyles, isInputValidStyles}, ref) => {
    const labelStyles = 'text-neutral-500 font-semibold uppercase mb-1';
    const defaultInputStyles = 'bg-stone-300 px-2 py-2 rounded';
    const typeBottomOutlineInputStyles = 'border-b-2 border-stone-400 focus:border-black';
    ...
    if (validateStyles && !isInputValidStyles) {
